...
<div class="content">
    ...
    <div class="container">
        <h3>ADD NEW BOOK</h3>
            ...
            <form method="post" action="ManageBook?action=add">
            <div class="form-container">
                <p>Book ID <font color="#FF0000">*</font>
                    <input type="number" name="bookId" required>
                </p>
                <p>Title <font color="#FF0000">*</font>
                    <input type="text" name="title" required>
                </p>
                <p>Author <font color="#FF0000">*</font>
                    <input type="text" name="author" required>
                </p>
                <p>Publication Year <font color="#FF0000">*</font>
                    <input type="number" name="publicationYear" required>
                </p>
                <p>Genre <font color="#FF0000">*</font>
                    <input type="text" name="genre" required>
                </p>
                <p>Status <font color="#FF0000">*</font>
